...
class NestleOptimizer(Optimizer):
    ...
    def __init__(self, observed=None, model=None, num_live_points=1500, method='multi', tol=0.5, sigma_fraction=0.1,inflation_terms=[], inflation_regions=[]):
        super().__init__('Nestle', observed, model, sigma_fraction, inflation_terms, inflation_regions)
    ...
    def compute_fit(self):
        ...
        def nestle_uniform_prior(theta):
            ...
            for idx, func in enumerate(self.fitting_func):
                cube.append(func(theta[idx]))
